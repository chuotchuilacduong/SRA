...
_RETRIEVAL = ExperimentSpec(
    ...
    methods=[
        ...
        Method(
            label="linearrag_top1",
            display_name="LinearRAG",
            provider="topk",
            provider_args={"source": "linearrag", "k": 1},
            engine="direct",
            engine_toolqa="react",
        ),
    ],
...
_MAIN_LINEARRAG = ExperimentSpec(
    name="main_linearrag",
    description="Main experiment using LinearRAG as retriever (mirrors `main` but source=linearrag).",
    methods=[
        Method(
            label="llm_direct",
            display_name="LLM Direct",
        ...
        Method(
            label="linearrag_top1",
            display_name="Full-Skill Injection (LinearRAG)",
            provider="topk",
            provider_args={"source": "linearrag", "k": 1},
            engine="direct",
            engine_toolqa="react",
        ...
        Method(
            label="linearrag_select",
            display_name="LLM Selection (LinearRAG)",
            provider="llm_select",
            provider_args={"source": "linearrag", "pool": 50},
            engine="direct",
            engine_toolqa="react",
        ),
        Method(
            label="linearrag_pd",
            display_name="Progressive Disclosure (LinearRAG)",
            provider="topk",
            provider_args={"source": "linearrag", "k": 50},
            engine="progressive_disclosure",
            engine_toolqa="react_progressive_disclosure",
        ),
    ],
